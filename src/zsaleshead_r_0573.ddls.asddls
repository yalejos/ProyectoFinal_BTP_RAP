...
define root view entity zsaleshead_r_0573
  ...
  association [0..1] to Zcomp_logos_I_VH_0573 as _Logos on $projection.CompanyCode = _Logos.CompanyCode
{
  key head_uuid             as HeadUuid,
      ...
      @ObjectModel.text.association: '_Logos'
      company_code          as CompanyCode,
      _Logos.CompanyName    as CompanyName,
